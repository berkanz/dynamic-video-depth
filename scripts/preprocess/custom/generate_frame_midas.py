...
model = MidasNet(midas_pretrain_path, non_negative=True, resize=[256, 384], normalize_input=True)

model = model.eval().cuda()

data_list_root = "./datafiles/custom/JPEGImages/640p"
camera_path = "./datafiles/custom/triangulation"
mask_path = './datafiles/custom/Annotations/640p'
